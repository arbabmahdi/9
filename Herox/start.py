...
async def start_private(client: Client, message: Message):
 await message.reply_photo(
        ...
        caption=f"""سلااامم✨ **a خوش اومدیی {message.from_user.mention()} !**\n
 **با من تو گروهت اهنگ اجرا کن !!**
 **منو تو گروهت دعوت کن و ادمینم کن و لذت ببر💫**
 **طراح سازنده و پشتیبانی @Coalw**""",
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [InlineKeyboardButton(
                    "• دستورات", callback_data="cb_cmd"),],
                [
                    InlineKeyboardButton("• سازنده", url=f"https://t.me/COALW"),
                    InlineKeyboardButton("• پشتیبانی ", url=f"https://t.me/COALW"),
                ],
            ]
        ),
    )
